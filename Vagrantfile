...
Vagrant.configure("2") do |config|
  ...
  #   # Display the VirtualBox GUI when booting the machine
      vb.gui = true
	  ## enable below if using two monitors
...
#  config.vm.network :private_network, ip: '10.211.55.102'
  ...
  config.vm.provision "shell", path: "scripts/51_setup_JavaBuildTools.sh"
  config.vm.provision "shell", path: "scripts/60_setup_docker.sh"
